...
{
	// no external flash on this board
}
//�õ�������EEPROM�����У׼ֵ
//����ֵ��1���ɹ���ȡ����
//        0����ȡʧ�ܣ�Ҫ����У׼
...
{
	return 0;  // no external flash on this board
}	 
//��ʾ�ַ���
...
u8 TP_Init(void)
{
	// TCLK=PB11, TCS=PB12, TSDI=PB13, TSDO=PB14, TPEN=PB15
	RCC->APB2ENR |= 1<<3;
	GPIOB->CRH &= 0x00000FFF; // 保留PB8-PB10（LCD数据线）
	GPIOB->CRH |= 0x88333000; // PB15/14:输入上拉, PB13/12/11:推挽输出
	GPIOB->ODR |= 0xF800;
