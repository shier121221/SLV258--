...
//		GPIOA->CRH&=0X0FFFF0F0;
//		GPIOA->CRH|=0X30000308;
//		GPIOA->ODR|=0X8400;    
...
#endif 
void W25Q16_Write(u8 *Data,u32 address,u16 NumByteToWrite)
{
...
void W25Q16_Read(u8 *Data,u32 address,u16 NumByteToRead)
{
    u16 i;
    while(W25Q16_ReadSR());
    F_CS=0;
