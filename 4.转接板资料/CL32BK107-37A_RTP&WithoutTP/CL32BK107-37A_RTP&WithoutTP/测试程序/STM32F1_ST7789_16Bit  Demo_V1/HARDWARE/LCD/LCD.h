...
#define	LCD_RST_SET  GPIOC->BSRR=1<<15    //复位  	    	 PC15
#define	LCD_CS_SET  GPIOA->BSRR=1<<12    //片选端口  	     PA12
#define	LCD_RS_SET	GPIOA->BSRR=1<<15    //数据/命令       PA15	   
#define	LCD_WR_SET	GPIOC->BSRR=1<<13    //写数据					 PC13
#define	LCD_RD_SET	GPIOC->BSRR=1<<14    //读数据					 PC14

#define	LCD_RST_CLR  GPIOC->BRR=1<<15    //复位  	    		 PC15
#define	LCD_CS_CLR  GPIOA->BRR=1<<12     //片选端口  	     PA12
#define	LCD_RS_CLR	GPIOA->BRR=1<<15     //数据/命令       PA15   
#define	LCD_WR_CLR	GPIOC->BRR=1<<13     //写数据					 PC13
#define	LCD_RD_CLR	GPIOC->BRR=1<<14     //读数据					 PC14  	

#define	LCD_LED PAout(2) //背光 开关
